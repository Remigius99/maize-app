...
import TanzaniaFlag from "../assets/tanzania.jpg";
...
const Navbar = () => {
  ...
  // Logout handler: clear storage and redirect to login
  const handleLogout = () => {
    ...
    <header className="bg-black/80 backdrop-blur-md text-white drop-shadow-lg fixed top-0 w-full z-50 font-poppins">
      <div className="flex justify-between items-center h-20 px-4 md:px-8">
        ...
        <nav className="hidden md:flex space-x-6 items-center">
          ...
          {/* Education dropdown with active style */}
          ...
          {/* Language dropdown and user icon */}
          <div className="relative flex items-center space-x-2" ref={desktopDropdownRef}>
            <button
              onClick={toggleDropdown}
              className="flex items-center space-x-2 hover:text-[#00df9a]"
            >
              <img
                src={i18n.language === "sw" ? TanzaniaFlag : USAFlag}
                alt="Language"
                className="w-6 h-6"
              />
            ...
            {dropdown && (
              <div className="absolute top-10 left-0 bg-white text-black rounded shadow-lg z-50">
                <button
            ...
            {showUser && (
              <div
                ref={userPopupRef}
                className="absolute top-10 right-0 bg-white text-black rounded-xl shadow-lg p-4 z-50 border border-green-200 min-w-[240px] flex flex-col items-center"
              >
        ...
        {/* Mobile controls */}
        <div
          className="relative flex items-center gap-4 md:hidden"
        ...
        >
          ...
          <div className="relative">
            <button
              onClick={toggleDropdown}
              className="flex items-center space-x-1 hover:text-[#00df9a]"
            >
              <img
                src={i18n.language === "sw" ? TanzaniaFlag : USAFlag}
                alt="Language"
            ...
            {dropdown && (
              <div className="absolute top-8 left-0 bg-white text-black rounded shadow-md p-2 z-50">
                <button
                  onClick={() => changeLanguage("sw")}
                  className="flex items-center gap-2 hover:bg-gray-200 px-3 py-1 w-full"
                >
                  <span>Swahili</span>
                </button>
                <button
      ...
      {/* User info popup (shared for desktop and mobile) */}
      {showUser && (
        <div className="fixed top-20 right-8 bg-white rounded-xl shadow-lg p-6 z-50 border border-green-200 min-w-[260px] flex flex-col items-center" ref={userPopupRef}>
